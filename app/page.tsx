    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow border" style={{ borderColor: '#F59E0B33' }}>
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FEF3C7' }}>
                  <Bot className="w-7 h-7" style={{ color: '#F59E0B' }} />
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow border" style={{ borderColor: '#F59E0B33' }}>
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FEF3C7' }}>
                  <ShieldCheck className="w-7 h-7" style={{ color: '#F59E0B' }} />
                </div>
              </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#FFFBEB' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10" style={{ color: '#6B7280' }}>Join thousands of people who trust Get Point Quest for clear, unbiased guidance.</p>
