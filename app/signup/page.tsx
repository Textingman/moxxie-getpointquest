          ...
          {submitStatus === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start gap-3 pt-2">
                <input type="checkbox" id="termsAgreement" required className="mt-1 w-4 h-4 rounded" style={{ accentColor: '#F59E0B' }} />
                <label htmlFor="termsAgreement" className="text-sm" style={{ color: '#6B7280' }}>
                  I have read and agree to the{' '}
                  <a href="/privacy" style={{ color: '#F59E0B' }} className="underline">Privacy Policy</a>
                  {' '}and{' '}
                  <a href="/terms" style={{ color: '#F59E0B' }} className="underline">Terms of Service</a>. *
                </label>
              </div>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="accountNotifications" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Transactional Account Notification SMS messages from Get Point Quest at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services.
                  </label>
                </div>
                <div className="flex items-start gap-3">
