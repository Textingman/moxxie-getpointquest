        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#6B7280' }}>
              Get Point Quest is an online gaming platform where every game, quest, and challenge you complete earns you real aura points and rewards. We built this for players who want more than just fun — they want to level up.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-4" style={{ color: '#6B7280' }}>
              Gaming should reward you. We built Get Point Quest because players deserve a platform where their time, skill, and dedication actually earn them something — aura points, prestige, and exclusive rewards.
            </p>
            <p className="text-lg mb-4" style={{ color: '#6B7280' }}>
            ...
            <p className="text-lg" style={{ color: '#6B7280' }}>
              Join thousands of players already earning aura on Get Point Quest. Your next quest is waiting.
            </p>
          </div>
