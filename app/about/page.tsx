        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#6B7280' }}>
              Get Point Quest is an AI-powered platform that guides individuals with honest, unbiased information. We're not a broker or salesperson. We're your independent advisor.
            </p>
          </div>
        </div>
      </section>
