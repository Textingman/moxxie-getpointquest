    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-md p-8">
        <div className="flex justify-center mb-6">
          <span className="text-2xl font-bold" style={{ color: '#F59E0B' }}>Get Point Quest</span>
        </div>
        <div className="flex justify-center mb-5">
          <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center">
            <CheckCircle className="w-8 h-8" style={{ color: '#F59E0B' }} strokeWidth={1.5} />
          </div>
        </div>
        ...
        <button
          ...
          style={{ backgroundColor: isRedirecting ? undefined : '#F59E0B' }}
        >
          {isRedirecting ? (
        ...
        <p className="text-xs text-gray-400 text-center mt-6">Secured by Get Point Quest</p>
      </div>
    </div>
  );
}
