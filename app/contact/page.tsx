          ...
          <div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" disabled={submitting} className="w-full py-3 px-6 rounded-lg text-white font-semibold transition-opacity" style={{ backgroundColor: submitting ? '#9CA3AF' : '#F59E0B', cursor: submitting ? 'not-allowed' : 'pointer' }}>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@getpointquest.com" className="text-base font-medium hover:underline" style={{ color: '#F59E0B' }}>support@getpointquest.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Get Point Quest<br />800 N King Street 304-1991<br />Wilmington, DE 19801</p>
                </div>
                <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#6B7280' }}>No. We do not sell or share your mobile number with third parties for marketing. See our <a href="/privacy" className="font-medium hover:underline" style={{ color: '#F59E0B' }}>Privacy Policy</a>.</p>
                </div>
              </div>
            </div>
          </div>
