...
export default function Footer() {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: '#78350F' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#FDE68A">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" style={{ color: '#FDE68A' }} className="hover:text-white">About</Link></li>
              <li><Link href="/signup" style={{ color: '#FDE68A' }} className="hover:text-white">Start Your Quest</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Legal</h4>
            <ul className="space-y-2">
              <li><Link href="/privacy" style={{ color: '#FDE68A' }} className="hover:text-white">Privacy Policy</Link></li>
              <li><Link href="/terms" style={{ color: '#FDE68A' }} className="hover:text-white">Terms of Service</Link></li>
              <li><Link href="/contact" style={{ color: '#FDE68A' }} className="hover:text-white">Contact Us</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Contact</h4>
            <p style={{ color: '#FDE68A' }}>support@getpointquest.com</p>
            <p className="mt-2" style={{ color: '#FDE68A' }}>800 N King Street 304-1991, Wilmington, DE 19801</p>
        ...
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #F59E0B', color: '#FDE68A' }}>
          <p>&copy; 2026 Get Point Quest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
